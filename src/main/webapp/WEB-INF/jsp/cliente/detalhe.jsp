    ...
    <div class="container-fluid">
        ...
        <form action="/cliente" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" data-mask="000.000.000-00" name="cpf" id="cpf" required>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Data de Nascimento</label>
                <input type="text" class="form-control" data-mask="00/00/0000" name="dataNascimento" id="dataNascimento" required>
            </div>
