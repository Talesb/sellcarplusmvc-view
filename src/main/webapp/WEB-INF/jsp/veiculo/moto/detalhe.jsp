...
<body>
	<div class="container-fluid">
		<a href="/veiculo/motos" class="btn btn-light mb-2"> Voltar</a>
		<form action="/veiculo/moto" method="post">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Cilindradas</label> <input
					type="number" class="form-control" id="cilindradas"
					name="cilindradas" aria-describedby="emailHelp" required>
			</div>
